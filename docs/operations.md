...
`delta-trade-risk-forge` is centered on trading systems work in Zig. The technical target is: Design a Zig verification harness for risk systems, covering graph analysis, node-edge fixtures, and failure-oriented tests.
