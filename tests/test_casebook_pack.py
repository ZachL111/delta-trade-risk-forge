"""Regression checks for the delta-trade-risk-forge casebook."""
...
from casebook.harness import assert_expected, delta_trade_risk_forge_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(delta_trade_risk_forge_summary(), assert_expected())
